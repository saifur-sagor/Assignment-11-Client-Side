  ...
  const deliveryOptions = [
    {
      ...
      description:
        "Ideal for non-urgent book deliveries with careful handling.",
      icon: <FaBookOpen />,
    ...
    <section className="py-24 dark:bg-slate-900 overflow-hidden">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          >
            Delivery Service <span className="text-purple-600 ">Charges</span>
          </motion.h2>
          <p className="text-gray-600 dark:text-gray-400 max-w-xl mx-auto">
            Review our fixed delivery types. You can select these options during
            your book parcel booking process.
          </p>
        </div>
          ...
          {deliveryOptions.map((option) => (
            ...
            >
              <div className="bg-white dark:bg-slate-800 rounded-[calc(1.5rem-1px)] p-8 h-full flex flex-col justify-between">
                <div>
                  <div
                    className={`w-16 h-16 rounded-2xl bg-gradient-to-r ${option.gradient} flex items-center justify-center text-white text-3xl mb-6 shadow-lg`}
                  >
                    {option.icon}
                  </div>
